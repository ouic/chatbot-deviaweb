      ...
      {!(apiKey || serverSideApiKeyIsSet) ? (
        <div className="mx-auto flex h-full w-[300px] flex-col justify-center space-y-6 sm:w-[600px]">
          ...
          <div className="text-center text-gray-500 dark:text-gray-400">
            <div className="mb-2">
              Deviaweb Chatbot vous permet d'entrer votre clé API pour utiliser cette interface
            </div>
            <div className="mb-2">
              <span className="italic"><u>uniquement</u></span> avec l'API d'OpenAI.
            </div>
            <div className="mb-2">
              {t(
            ...
            <div>
              {t("Si vous n'avez pas de clé API, vous pouvez en obtenir une ici : ")}
              <a
